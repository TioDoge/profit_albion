                                ...
                                if (prevMonth.getUTCDay() === this.o.weekStart) {
                                    ...
                                    if (this.o.calendarWeeks) {
                                        ...
                                        var
                                                ...
                                                wsxx = new Date(+prevMonth + (this.o.weekStart - prevMonth.getUTCDay() - 7) % 7 * 864e5),
                                                // Thursday of this week
                                                th = new Date(Number(wsx) + (7 + 4 - wsx.getUTCDay()) % 7 * 864e5),
...
// Derive options from locale plugins
                    ...
                    var defaults = $.fn.datepicker.defaults = {
                        ...
                        title: '',
                        templates: {
                            leftArrow: '<span class="fa fa-chevron-left"></span>',
                            rightArrow: '<span class="fa fa-chevron-right"></span>'
                        }
                    };
