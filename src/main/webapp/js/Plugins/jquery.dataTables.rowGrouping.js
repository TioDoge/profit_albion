...
(function ($) {
    ...
    $.fn.rowGrouping = function (options) {
        ...
        var defaults = {
            ...
            sGroupingClassIconExpanded: 'fa fa-chevron-up',
            sGroupingClassIconCollapsed: 'fa fa-chevron-down',
            ...
            sGroupingClassIconExpanded2: 'fa fa-chevron-up',
            sGroupingClassIconCollapsed2: 'fa fa-chevron-down',
        ...
        return this.each(function (index, elem) {
            ...
            function fnCreateGroupRow(sGroupCleaned, sGroup, iColspan) {
                ...
                nCell.innerHTML = "<i></i>"+properties.sGroupLabelPrefix + properties.fnGroupLabelFormat(sGroup == "" ? properties.sEmptyGroupLabel : sGroup, oGroup) ;
                if (properties.bExpandableGrouping) {
                    ...
                    if (!_fnIsGroupCollapsed(sGroupCleaned)) {
                        ...
                        $(nCell).find("i").removeClass(properties.sGroupingClassIconCollapsed);
                        $(nCell).find("i").addClass(properties.sGroupingClassIconExpanded);
                    } else {
                        nCell.className += " collapsed-group";
                        oGroup.state = "collapsed";
                        $(nCell).find("i").removeClass(properties.sGroupingClassIconExpanded);
                        $(nCell).find("i").addClass(properties.sGroupingClassIconCollapsed);
                    }
            ...
            function _fnCreateGroup2Row(sGroup2, sGroupLabel, iColspan, oParentGroup) {
                ...
                nCell2.innerHTML =  "<i></i>"+ properties.sGroupLabelPrefix2 + properties.fnGroupLabelFormat2(sGroupLabel == "" ? properties.sEmptyGroupLabel : sGroupLabel, oGroup) ;
                ...
                if (properties.bExpandableGrouping && properties.bExpandableGrouping2) {
                    ...
                    if (!_fnIsGroupCollapsed(oGroup.dataGroup)) {
                        ...
                        oGroup.state = "expanded";
                        $(nCell2).find("i").removeClass(properties.sGroupingClassIconCollapsed);
                        $(nCell2).find("i").addClass(properties.sGroupingClassIconExpanded);
                    } else {
                        nCell2.className += " collapsed-group";
                        oGroup.state = "collapsed";
                        $(nCell2).find("i").removeClass(properties.sGroupingClassIconExpanded);
                        $(nCell2).find("i").addClass(properties.sGroupingClassIconCollapsed);
                    }
...
//                return sGroup.toLowerCase().replace(/\W+/g, "-"); //Fix provided by bmathews (Issue 7)
            ...
            function _rowGroupingRowFilter(oSettings, aData, iDataIndex) {
                ...
                if (oSettings.nTable.id !== oTable[0].id)
                    return true;
            ...
            function fnExpandGroup(sGroup) {
                ...
                $("td[data-group^='" + sGroup + "']").find("i").removeClass(properties.sGroupingClassIconCollapsed);
                $("td[data-group^='" + sGroup + "']").find("i").addClass(properties.sGroupingClassIconExpanded);
            ...
            function fnCollapseGroup(sGroup) {
                ...
                $("td[data-group^='" + sGroup + "']").find("i").removeClass(properties.sGroupingClassIconExpanded);
                $("td[data-group^='" + sGroup + "']").find("i").addClass(properties.sGroupingClassIconCollapsed);
                if (properties.bUseFilteringForGrouping)
                {
                    oTable.fnDraw();
                    return;//Because rows are expanded with _rowGroupingRowFilter function
